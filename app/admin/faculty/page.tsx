...
export default function FacultyPage() {
  ...
  const facultyTransactions = payments.filter(
    (t) => t.paymentType === "faculty_allocation"
  );
    ...
    <div className="space-y-6 p-8">
      <div>
        ...
        <p className="mt-1 text-slate-400">
          Manage faculty budgets and research allocations
        </p>
      </div>

      <PaymentStats transactions={facultyTransactions} />
      <PaymentTable
        transactions={facultyTransactions}
        title="All Faculty Transactions"
