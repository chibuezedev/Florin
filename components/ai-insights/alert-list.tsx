...
import { AlertTriangle, Shield, Activity, Lock, CheckCircle, Eye } from "lucide-react"
...
export function AlertList() {
  ...
  const filteredAlerts = mockAIAlerts.filter((alert) => {
    ...
    <Card className="border-slate-800 bg-slate-900/50 backdrop-blur">
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle className="text-lg font-semibold text-white">Security Alerts</CardTitle>
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <Badge className={`${getThreatLevelColor(alert.severity)} border-0 text-xs uppercase`}>
                          {alert.severity}
                        </Badge>
                        {alert.resolved && (
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                          ...
                          {alert.details.transactionFrequency && (
                            <Badge
                              ...
                              className="border-slate-700 bg-slate-800/50 text-xs text-slate-400"
                            >
                              Frequency: {alert.details.transactionFrequency}x
                            </Badge>
                          )}
